// ============================================================================
// FILE: src/screens/profile/ProfileScreen.jsx (UPDATED)
// ============================================================================
...
export const ProfileScreen = ({ navigation }) => {
  ...
  // NEW: Format location display (City, Country)
        ...
        <View style={styles.profileCard}>
          ...
          <View style={styles.quickActions}>
            ...
            >
              ...
              <Text style={styles.actionButtonTextSecondary}>Add Friend</Text>
            </TouchableOpacity>
          </View>
        </View>
          ...
          {friends && friends.length > 0 ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySubtext}>
                Add friends to see their prayer progress
              </Text>
              <TouchableOpacity
